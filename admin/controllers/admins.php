 ...
 * Admins Controller
 */
class Pro_criticalControllerAdmins extends JControllerForm
{
	/**
	...
	{
		$this->view_list = 'Admins_list'; // safeguard for setting the return view listing to the main view.
	...
	protected function allowEdit($data = array(), $key = 'id')
	{
		...
		if ($recordId)
		{
			...
			$permission = $user->authorise('core.edit', 'com_pro_critical.admins.' . (int) $recordId);
			if (!$permission)
			{
				if ($user->authorise('core.edit.own', 'com_pro_critical.admins.' . $recordId))
				{
	...
	public function batch($model = null)
	{
		...
		// Set the model
		$model = $this->getModel('Admins', '', array());

		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_pro_critical&view=admins_list' . $this->getRedirectToListAppend(), false));
