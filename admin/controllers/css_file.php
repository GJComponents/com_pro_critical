 ...
 * Css_file Controller
 */
class Pro_criticalControllerCss_file extends JControllerForm
{
	/**
	...
	{
		$this->view_list = 'Css_file_list'; // safeguard for setting the return view listing to the main view.
		parent::__construct($config);
	}

#Custom Buttons PHP (controller methods)[css_file]
...
#Add PHP (allowAdd Method) *
	...
	protected function allowEdit($data = array(), $key = 'id')
	{
		...
		if ($recordId)
		{
			...
			$permission = $user->authorise('core.edit', 'com_pro_critical.css_file.' . (int) $recordId);
			if (!$permission)
			{
				if ($user->authorise('core.edit.own', 'com_pro_critical.css_file.' . $recordId))
				{
	...
	public function batch($model = null)
	{
		...
		// Set the model
		$model = $this->getModel('Css_file', '', array());

		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_pro_critical&view=css_file_list' . $this->getRedirectToListAppend(), false));
