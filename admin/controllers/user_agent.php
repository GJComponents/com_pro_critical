...
/**
 * User_agent Controller
 */
class Pro_criticalControllerUser_agent extends JControllerForm
{
	/**
	...
	{
		$this->view_list = 'User_agent_list'; // safeguard for setting the return view listing to the main view.
		parent::__construct($config);
	}

#OnBtnCleanAllTable PHP (controller methods)
/*public function OnBtnCleanAllTable(){
	...
	protected function allowEdit($data = array(), $key = 'id')
	{
		...
		if ($recordId)
		{
			...
			$permission = $user->authorise('core.edit', 'com_pro_critical.user_agent.' . (int) $recordId);
			if (!$permission)
			{
				if ($user->authorise('core.edit.own', 'com_pro_critical.user_agent.' . $recordId))
				{
	...
	public function batch($model = null)
	{
		...
		// Set the model
		$model = $this->getModel('User_agent', '', array());

		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_pro_critical&view=user_agent_list' . $this->getRedirectToListAppend(), false));
