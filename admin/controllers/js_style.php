 ...
 * Js_style Controller
 */
class Pro_criticalControllerJs_style extends JControllerForm
{
	/**
	...
	{
		$this->view_list = 'Js_style_list'; // safeguard for setting the return view listing to the main view.
		parent::__construct($config);
	}

#Custom Buttons PHP (controller methods) [js_style]
	...
	protected function allowEdit($data = array(), $key = 'id')
	{
		...
		if ($recordId)
		{
			...
			$permission = $user->authorise('core.edit', 'com_pro_critical.js_style.' . (int) $recordId);
			if (!$permission)
			{
				if ($user->authorise('core.edit.own', 'com_pro_critical.js_style.' . $recordId))
				{
	...
	public function batch($model = null)
	{
		...
		// Set the model
		$model = $this->getModel('Js_style', '', array());

		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_pro_critical&view=js_style_list' . $this->getRedirectToListAppend(), false));
