...
/**
 * User_agent_browser Controller
 */
class Pro_criticalControllerUser_agent_browser extends JControllerForm
{
	/**
	...
	{
		$this->view_list = 'User_agent_browser_list'; // safeguard for setting the return view listing to the main view.
	...
	protected function allowEdit($data = array(), $key = 'id')
	{
		...
		if ($recordId)
		{
			...
			$permission = $user->authorise('core.edit', 'com_pro_critical.user_agent_browser.' . (int) $recordId);
			if (!$permission)
			{
				if ($user->authorise('core.edit.own', 'com_pro_critical.user_agent_browser.' . $recordId))
				{
	...
	public function batch($model = null)
	{
		...
		// Set the model
		$model = $this->getModel('User_agent_browser', '', array());

		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_pro_critical&view=user_agent_browser_list' . $this->getRedirectToListAppend(), false));
