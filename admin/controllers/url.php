 ...
 * Url Controller
 */
class Pro_criticalControllerUrl extends JControllerForm
{
	/**
	...
	{
		$this->view_list = 'Url_list'; // safeguard for setting the return view listing to the main view.
		parent::__construct($config);
	}

#Custom Buttons PHP (controller methods)[url]
	...
	protected function allowEdit($data = array(), $key = 'id')
	{
		...
		if ($recordId)
		{
			...
			$permission = $user->authorise('core.edit', 'com_pro_critical.url.' . (int) $recordId);
			if (!$permission)
			{
				if ($user->authorise('core.edit.own', 'com_pro_critical.url.' . $recordId))
				{
	...
	public function batch($model = null)
	{
		...
		// Set the model
		$model = $this->getModel('Url', '', array());

		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_pro_critical&view=url_list' . $this->getRedirectToListAppend(), false));
