...
/**
 * Css_style Controller
 */
class Pro_criticalControllerCss_style extends JControllerForm
{
	/**
	...
	{
		$this->view_list = 'Css_style_list'; // safeguard for setting the return view listing to the main view.
		parent::__construct($config);
	}

#Custom Buttons PHP (controller methods) [css_style]
	...
	protected function allowEdit($data = array(), $key = 'id')
	{
		...
		if ($recordId)
		{
			...
			$permission = $user->authorise('core.edit', 'com_pro_critical.css_style.' . (int) $recordId);
			if (!$permission)
			{
				if ($user->authorise('core.edit.own', 'com_pro_critical.css_style.' . $recordId))
				{
	...
	public function batch($model = null)
	{
		...
		// Set the model
		$model = $this->getModel('Css_style', '', array());

		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_pro_critical&view=css_style_list' . $this->getRedirectToListAppend(), false));
