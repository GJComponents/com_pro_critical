...
/**
 * Device_client Controller
 */
class Pro_criticalControllerDevice_client extends JControllerForm
{
	/**
	...
	{
		$this->view_list = 'Device_client_list'; // safeguard for setting the return view listing to the main view.
	...
	public function batch($model = null)
	{
		...
		// Set the model
		$model = $this->getModel('Device_client', '', array());

		// Preset the redirect
		$this->setRedirect(JRoute::_('index.php?option=com_pro_critical&view=device_client_list' . $this->getRedirectToListAppend(), false));
