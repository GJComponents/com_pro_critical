...
// Get the user object.
		...
		$query->select($db->quoteName(array('a.id','a.view_component'),array('id','component_view_id_view_component')));
		...
		if ($items)
		{
			...
			{
				$options[] = JHtml::_('select.option', $item->id, $item->component_view_id_view_component);
			}
		}
		return $options;
	}
