...
class JFormFieldOslist extends JFormFieldList
{
	...
	protected function getInput()
	{
		...
		if ($set_button === 'true')
		{
			...
			// [Fields 3456] only add if user allowed to create user_agent_os
			...
			// [Fields 3472] only add if user allowed to edit user_agent_os
			...
			// [Fields 3513] check if button was created for user_agent_os field.
