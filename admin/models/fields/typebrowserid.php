...
class JFormFieldTypebrowserid extends JFormFieldList
{
	...
	protected function getInput()
	{
		...
		if ($set_button === 'true')
		{
			...
			// [Fields 3456] only add if user allowed to create type_browser
			...
			// [Fields 3472] only add if user allowed to edit type_browser
			...
			// [Fields 3513] check if button was created for type_browser field.
