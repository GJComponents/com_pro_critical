...
class JFormFieldCriticalcssview extends JFormFieldList
{
	...
	protected function getInput()
	{
		...
		if ($set_button === 'true')
		{
			...
			// [Fields 4857] only add if user allowed to create directory_views
			...
			// [Fields 4893] only add if user allowed to edit directory_views
			...
			// [Fields 4968] check if button was created for directory_views field.
