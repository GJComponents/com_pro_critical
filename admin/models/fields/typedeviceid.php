...
class JFormFieldTypedeviceid extends JFormFieldList
{
	...
	protected function getInput()
	{
		...
		if ($set_button === 'true')
		{
			...
			// [Fields 3456] only add if user allowed to create type_device
			...
			// [Fields 3472] only add if user allowed to edit type_device
			...
			// [Fields 3513] check if button was created for type_device field.
