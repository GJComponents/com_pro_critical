...
class JFormFieldBrowseridfield extends JFormFieldList
{
	...
	protected function getInput()
	{
		...
		if ($set_button === 'true')
		{
			...
			// [Fields 4857] only add if user allowed to create user_agent_browser
			...
			// [Fields 4893] only add if user allowed to edit user_agent_browser
			...
			// [Fields 4968] check if button was created for user_agent_browser field.
