 ...
 * Cache_list Model
 */
class Pro_criticalModelCache_list extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		$query->from($db->quoteName('#__pro_critical_cache', 'a'));

		// [Interpretation 9740] From the pro_critical_url table.
		...
		// [Interpretation 9776] Filter by Type.
	...
	protected function checkInNow()
	{
		...
		if ($time)
		{
			...
			if ($db->getNumRows())
			{
				...
				$query->update($db->quoteName('#__pro_critical_cache'))->set($fields)->where($conditions); 
