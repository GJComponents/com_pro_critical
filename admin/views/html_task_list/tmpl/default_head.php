...
<tr>
	...
	<?php endif; ?>
	<th class="nowrap" >
			<?php echo JHtml::_('grid.sort', 'COM_PRO_CRITICAL_HTML_TASK_TASK_ID_LABEL', 'task_id', $this->listDirn, $this->listOrder); ?>
	</th>
	...
	<?php if ($this->canState): ?>
		<th width="10" class="nowrap center" >
			<?php echo JHtml::_('grid.sort', 'COM_PRO_CRITICAL_HTML_TASK_STATUS', 'published', $this->listDirn, $this->listOrder); ?>
		</th>
	<?php else: ?>
		<th width="10" class="nowrap center" >
			<?php echo JText::_('COM_PRO_CRITICAL_HTML_TASK_STATUS'); ?>
		</th>
	<?php endif; ?>
	<th width="5" class="nowrap center hidden-phone" >
			<?php echo JHtml::_('grid.sort', 'COM_PRO_CRITICAL_HTML_TASK_ID', 'id', $this->listDirn, $this->listOrder); ?>
	</th>
</tr>