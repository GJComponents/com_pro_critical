 ...
 * Url View class
 */
class Pro_criticalViewUrl extends JViewLegacy
{
	/**
	...
	public function display($tpl = null)
	{
		...
		$this->canDo = Pro_criticalHelper::getActions('url', $this->item);
		// get input
	...
	protected function addToolBar()
	{
		...
		else
		{
			...
			else
			{
				...
				if ($this->canDo->get('core.create'))
				{
					JToolBarHelper::custom('url.save2copy', 'save-copy.png', 'save-copy_f2.png', 'JTOOLBAR_SAVE_AS_COPY', false);
				}
				JToolBarHelper::cancel('url.cancel', 'JTOOLBAR_CLOSE');
			}
		}
	...
	protected function setDocument()
	{
		...
		$this->document->setTitle(JText::_($isNew ? 'COM_PRO_CRITICAL_URL_NEW' : 'COM_PRO_CRITICAL_URL_EDIT'));
		$this->document->addStyleSheet(JURI::root() . "administrator/components/com_pro_critical/assets/css/url.css", (Pro_criticalHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
		...
		$this->document->addScript(JURI::root() . "administrator/components/com_pro_critical/views/url/submitbutton.js", (Pro_criticalHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/javascript'); 
