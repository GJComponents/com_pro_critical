...
if ($this->saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_pro_critical&task=js_style_list.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_pro_critical&view=js_style_list'); ?>" method="post" name="adminForm" id="adminForm">
