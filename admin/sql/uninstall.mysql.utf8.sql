...
DROP TABLE IF EXISTS `#__pro_critical_device_client`;
DROP TABLE IF EXISTS `#__pro_critical_admins`;
DROP TABLE IF EXISTS `#__pro_critical_html_task`;
DROP TABLE IF EXISTS `#__pro_critical_type_device`;
DROP TABLE IF EXISTS `#__pro_critical_type_browser`;
DROP TABLE IF EXISTS `#__pro_critical_directory_components`;
