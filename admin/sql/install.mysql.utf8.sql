...
CREATE TABLE IF NOT EXISTS `#__pro_critical_css` (
	...
	`type_device_id` INT NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `#__pro_critical_admins` (
	...
	`admin_panel_on` INT NOT NULL DEFAULT 0,
	`ip_user_admin` VARCHAR(255) NOT NULL DEFAULT '',
	`user_as_admin_id` INT NOT NULL DEFAULT 0,
	`params` text NOT NULL,
	`published` TINYINT(3) NOT NULL DEFAULT 1,
	`created_by` INT(10) unsigned NOT NULL DEFAULT 0,
	`modified_by` INT(10) unsigned NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `#__pro_critical_html_task` (
	`id` INT(11) NOT NULL AUTO_INCREMENT,
	`asset_id` INT(10) unsigned NOT NULL DEFAULT 0 COMMENT 'FK to the #__assets table.',
	`component_view_id` INT(11) NOT NULL DEFAULT 0,
...
-- #__pro_critical_css_file
CREATE TABLE IF NOT EXISTS `#__pro_critical_css_file` (
	`id`                INT(11) NOT NULL AUTO_INCREMENT,
	`asset_id`          INT(10) unsigned NOT NULL DEFAULT 0     COMMENT 'FK to the #__assets table.',
	`attrs`             TEXT NOT NULL                           COMMENT 'Element attributes',
...
--
-- Структура таблицы `#__pro_critical_css_style`
--
CREATE TABLE IF NOT EXISTS `#__pro_critical_css_style` (
    `id` int(11) NOT NULL AUTO_INCREMENT,
      ...
      `load` int(11) NOT NULL DEFAULT '0',
      `minify` int(11) NOT NULL DEFAULT '0',
      `use_critical` int(11) NOT NULL DEFAULT '1' COMMENT 'Use when creating critical styles.',
      `force_to_critical` int(11) NOT NULL DEFAULT '0' COMMENT 'Force adding to critical style.',
      `type` varchar(50) NOT NULL DEFAULT 'text/css' COMMENT 'Tells the browser what syntax to use to interpret the styles correctly',
      `media` varchar(50) NOT NULL DEFAULT 'all' COMMENT 'The output device for which the stylesheet is intended',
      `params` text NOT NULL,
      `published` tinyint(3) NOT NULL DEFAULT '1',
      `created_by` int(10) unsigned NOT NULL DEFAULT '0',
      `modified_by` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `#__pro_critical_js_style`
--
CREATE TABLE IF NOT EXISTS `#__pro_critical_js_style` (
  ...
  KEY `idx_modifiedby` (`modified_by`),
  KEY `idx_state` (`published`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=0 ;

--
-- Структура таблицы `#__pro_critical_js_file`
--
