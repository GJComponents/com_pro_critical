...
/**
 * Css_list Table class
 */
class Pro_criticalTableCss extends JTable
{
	/**
	...
	{
		parent::__construct('#__pro_critical_css', 'id', $db);
	}	
	...
	/**
	 * Overload the store method for the Css table.
	 *
	...
	public function store($updateNulls = false)
	{
		...
		{
			// New css. A css created and created_by field can be set by the user,
		...
		if (isset($this->alias))
		{
			...
			{
				$this->setError(JText::_('COM_PRO_CRITICAL_CSS_ERROR_UNIQUE_ALIAS'));
				return false;
			}
		}
	...
	public function check()
	{
		...
		if (!$this->getRules())
		{
			$rules = $this->getDefaultAssetValues('com_pro_critical.css.'.$this->id);
			$this->setRules($rules);
		}
	...
	{
		$k = $this->_tbl_key;
		return 'com_pro_critical.css.'.(int) $this->$k;
	}
